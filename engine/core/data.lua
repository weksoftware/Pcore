...
data.settings = {vsync=1, display_debug=2, language=1, zoom=4, autosave=2, player_color=2, shaders=2, nickname="player"}
...
data.multiplayer = {ip = "localhost", port = "60776", enet_type = nil, save_name="world1.json", world_load_status = 0}
