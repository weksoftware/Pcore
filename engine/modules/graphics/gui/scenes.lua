...
scenes.game.func = gui_funcs.game_update
scenes.game.windows = {
    {
        x=0,
        y=0,
        ...
        button=gui_funcs.inventory_update,
        id=1
    },
    {
        x=5,
    ...
    },
    {
        ...
        button=gui_funcs.item_name_inventory_update
    }
}
...
scenes.multiplayer.windows = {
    ...
    },
    {
        ...
        button=gui_funcs.multiplayer_nickname
    },
    {
        x=50,
        y=75,
...
scenes.nickname = {}
scenes.nickname.display_game = true
scenes.nickname.windows = {
    {
        x=0,
        y=0,
        w=100,
    ...
    },
    {
        ...
        button=gui_funcs.nickname_text
    },
    {
        x=0,
        y=20,
